...
public class SyntacticAnalyzer {
                ...
                if (token.getSymbol().equals("sprograma")) {
                    ...
                    if (!isEmpty(token)) {
                        if (token.getSymbol().equals("sidentificador")) {
                                ...
                                if (token.getSymbol().equals("sponto_vírgula")) {
                                    ...
                                    if (token.getSymbol().equals("sponto")) {
                                        if (!lexicalAnalyzer.hasFileEnd()) {
                                            this.message.endoffileError(token.getSymbol(), token.getLine());
                                            throw new Exception();
                                        }
                                    } else {
                                        this.message.dotError(token.getSymbol(), token.getLine());
                                        throw new Exception();
                                    }

                                } else {
                                    this.message.semicolonError(token.getSymbol(), token.getLine());
                                    throw new Exception();
                                }
                            ...
                            this.message.identifierError(token.getSymbol(), token.getLine());
                            throw new Exception();
                        }
                    ...
                    this.message.programError(token.getSymbol(), token.getLine());
                    throw new Exception();
                }
                        ...
                        if (token.getSymbol().equals("svirgula")) {
                            ...
                            if (!isEmpty(token)) {
                                if (token.getSymbol().equals("sdoispontos")) {
                                    this.message.colonError(token.getSymbol(), token.getLine());
                                    throw new Exception();
                                }
                    ...
                    if (token.getSymbol().equals("sdoispontos")) {
                        ...
                        if (!isEmpty(token)) {
                            if (token.getSymbol().equals("sinteiro") || token.getSymbol().equals("sbooleano")) {
                                ...
                                this.message.typeError(token.getSymbol(), token.getLine());
                                throw new Exception();
                            }
                        } else {
                            throw new Exception();
    ...
    private void analyzeCommands() throws Exception {
        if (token.getSymbol().equals("sinício")) {
            ...
            this.message.beginError(token.getSymbol(), token.getLine());
            throw new Exception();
        }
    }
    ...
    private void analyzeRead() throws Exception {
        ...
        if (!isEmpty(token)) {
            if (token.getSymbol().equals("sabre_parênteses")) {
                    ...
                    if (token.getSymbol().equals("sidentificador")) {
                        ...
                        if (!isEmpty(token)) {
                            if (token.getSymbol().equals("sfecha_parênteses")) {
                                ...
                                this.message.closeparenthesesError(token.getSymbol(), token.getLine());
                                throw new Exception();
                            }
                        }
                ...
                this.message.openparenthesesError(token.getSymbol(), token.getLine());
                throw new Exception();
            }
    ...
    private void analyzeWhile() throws Exception {
        ...
        if (!isEmpty(token)) {
            ...
            if (token.getSymbol().equals("sfaca")) {
                ...
                this.message.doError(token.getSymbol(), token.getLine());
                throw new Exception();
            }
        } else {
            throw new Exception();
    ...
    private void analyzeIf() throws Exception {
        ...
        if (!isEmpty(token)) {
            ...
            if (token.getSymbol().equals("sentao")) {
                ...
                this.message.thenError(token.getSymbol(), token.getLine());
                throw new Exception();
            }
    ...
    private void analyzeType() throws Exception {
        if (token.getSymbol().equals("sinteiro") || token.getSymbol().equals("sbooleano")) {
            ...
            message.typeError(token.getSymbol(), token.getLine());
            throw new Exception();
        }
    ...
    private void analyzeFactor() throws Exception {
        if (token.getSymbol().equals("sidentificador")) {
            ...
            this.message.booleanError(token.getSymbol(), token.getLine());
            throw new Exception();
        }
    }
}
